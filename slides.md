...
<img :src="$base + 'images/slach.jpg'" class="rounded-xl shadow-lg mt-12 ml-8" style="max-height: 350px;" />
...
<div class="absolute bottom-2 left-1/2 -translate-x-1/2" style="pointer-events:none;">
  <img :src="$base + 'images/hads_up.png'" style="height: 280px; opacity: 0.9;" />
</div>
...
<div class="absolute left-0 right-0 flex items-center justify-center" style="top: 2rem; bottom: 0;">
  <v-switch>
    <template #1><img :src="$base + 'images/use_skills_1.png'" class="rounded-lg shadow-lg" style="max-width: 95%; max-height: 100%; object-fit: contain;" /></template>
    <template #2><img :src="$base + 'images/use_skills_2.png'" class="rounded-lg shadow-lg" style="max-width: 95%; max-height: 100%; object-fit: contain;" /></template>
    <template #3><img :src="$base + 'images/use_skills_4.png'" class="rounded-lg shadow-lg" style="max-width: 95%; max-height: 100%; object-fit: contain;" /></template>
    <template #4><img :src="$base + 'images/use_skills_5.png'" class="rounded-lg shadow-lg" style="max-width: 95%; max-height: 100%; object-fit: contain;" /></template>
    <template #5><img :src="$base + 'images/use_skills_6.png'" class="rounded-lg shadow-lg" style="max-width: 95%; max-height: 100%; object-fit: contain;" /></template>
  </v-switch>
</div>
...
<div class="absolute bottom-4 left-1/2 -translate-x-1/2 flex flex-col items-center">
  <a href="https://github.com/Altinity/Skills" target="_blank" rel="noopener">
    <img :src="$base + 'images/qr-altinity-skills.png'" class="w-40 h-40" />
  </a>
...
<div class="absolute bottom-4 left-1/2 -translate-x-1/2 flex flex-col items-center">
  <a href="https://github.com/ClickHouse/agent-skills" target="_blank" rel="noopener">
    <img :src="$base + 'images/qr-clickhouse-agent-skills.png'" class="w-40 h-40" />
  </a>
...
<div class="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center">
  <a href="https://t.me/bloodjazman" target="_blank" rel="noopener">
    <img :src="$base + 'images/qr-telegram.png'" class="w-40 h-40" />
  </a>
